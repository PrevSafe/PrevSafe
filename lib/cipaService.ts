...
export const INITIAL_CIPA_PROCESSES: CipaManagementProcess[] = [
  {
    ...
    timeline: {
      start_mandate_date: '2026-10-01',
      end_mandate_date: '2027-09-30',
      mandate_end_date: '2027-09-30',
      convocation_date: '2026-08-01',
      electoral_commission_date: '2026-08-06',
      ...
      candidacy_publication_date: '2026-09-01',
  ...
  },
  {
    ...
    timeline: {
      start_mandate_date: '2026-03-01',
      end_mandate_date: '2028-02-29',
      mandate_end_date: '2028-02-29',
      convocation_date: '2026-01-01',
      electoral_commission_date: '2026-01-05',
      ...
      candidacy_publication_date: '2026-02-01',
