      ...
      {markdown && (
        <article
          className="documento-ata mt-6 rounded-xl border border-outline-variant/40 bg-surface-container-lowest p-10
            ...
            [&_p]:mb-3 [&_p]:text-justify [&_ul]:mb-4 [&_ul]:list-disc [&_ul]:pl-6 [&_li]:mb-1
            [&_hr]:my-8 [&_hr]:border-outline-variant
            [&_table]:w-full [&_table]:my-5 [&_table]:text-[11pt] [&_table]:border-collapse [&_table]:border [&_table]:border-[#000]
            [&_th]:border [&_th]:border-[#000] [&_th]:bg-surface-container-low [&_th]:px-2 [&_th]:py-2 [&_th]:text-left [&_th]:font-sans [&_th]:text-label-sm [&_th]:uppercase [&_th]:tracking-wider
            [&_td]:border [&_td]:border-[#000] [&_td]:px-2 [&_td]:py-2
            [&_.linha-grupo_td]:font-bold [&_.linha-grupo_td]:text-center [&_.linha-grupo_td]:bg-surface-container-low
            ...
            [&_.rotulo-assinatura-linha]:block
            [&_.documento-logotipo]:text-left [&_.documento-logotipo]:italic [&_.documento-logotipo]:text-outline [&_.documento-logotipo]:font-sans [&_.documento-logotipo]:text-label-sm [&_.documento-logotipo]:mb-6
            [&_.documento-titulo]:text-center [&_.documento-titulo]:uppercase [&_.documento-titulo]:font-bold [&_.documento-titulo]:text-2xl [&_.documento-titulo]:mb-2 [&_.documento-titulo]:text-[#000]
            [&_.documento-subtitulo]:text-center [&_.documento-subtitulo]:font-bold [&_.documento-subtitulo]:text-lg [&_.documento-subtitulo]:mb-6 [&_.documento-subtitulo]:text-[#000]
            [&_.documento-titulo-tabela]:text-center [&_.documento-titulo-tabela]:font-bold [&_.documento-titulo-tabela]:mt-6 [&_.documento-titulo-tabela]:mb-2 [&_.documento-titulo-tabela]:text-[#000]
